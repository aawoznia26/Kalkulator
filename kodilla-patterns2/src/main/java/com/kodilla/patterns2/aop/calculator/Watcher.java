...
public class Watcher {
    ...
    @Around("execution(* com.kodilla.patterns2.aop.calculator.Calculator.factorial(..)) " +
            "|| execution(* com.kodilla.patterns2.api.OrderFacade.processOrder(..))")
    ...
    @Before("execution(* com.kodilla.patterns2.api.OrderFacade.processOrder(..))" + "&& target(object)")
    public void logOrder(Object object) {
        LOGGER.info("Class: " + object.getClass().getName() + " started order processing");
    }
}
